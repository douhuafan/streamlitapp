...
feature_cols = ['Age','Cardiogenic shock', 'Coronary hypoperfusion','Systolic blood pressure1','hs-TnI','fibrinogen degradathon product', 'D-dimer ',
                'blood sugar','creatinine','muscle hemoglobin',
               'LDH','glutamic transminase','lactic acid','Coronary artery disease']
